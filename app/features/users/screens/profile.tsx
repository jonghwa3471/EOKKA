...
export default function Profile({ loaderData }: Route.ComponentProps) {
  ...
  const { name, email, avatarUrl, marketingConsent, createdAt, providers } =
    loaderData;
      ...
      <div className="mx-auto w-full max-w-5xl">
        ...
        <section className="bg-card relative mt-7 overflow-hidden rounded-[2rem] border p-6 shadow-sm md:p-9">
          ...
          <div className="relative flex flex-col gap-6 sm:flex-row sm:items-center">
            ...
            <span className="inline-flex w-fit items-center gap-2 rounded-full border border-emerald-500/20 bg-emerald-500/10 px-3 py-2 text-xs font-black text-emerald-600 dark:text-emerald-400">
              <ShieldCheckIcon className="size-4" /> 계정 보호 중
            </span>
          </div>
        </section>
